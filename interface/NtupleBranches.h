...
//  std::vector<float>              genParticle_e        ;
  ...
  std::vector<int>       BsTauTau_tau_pi1_charge;// change
  std::vector<int>       BsTauTau_tau_pi2_charge;// change
  std::vector<int>       BsTauTau_tau_pi3_charge;// change
  std::vector<float>       BsTauTau_tau_pi1_dz;// change
  std::vector<float>       BsTauTau_tau_pi2_dz;// change
  std::vector<float>       BsTauTau_tau_pi3_dz;// change
  std::vector<float>       BsTauTau_tau_muon_dr1;// change
  std::vector<float>       BsTauTau_tau_muon_dr2;// change
  std::vector<float>       BsTauTau_tau_muon_dr3;// change
  ...
  std::vector<float>                BsTauTau_muonpion_maxdoca; //change
  std::vector<float>                BsTauTau_muonpion_mindoca; //change
  ...
  // change
  int allParticle_N;
  std::vector<int>         allParticle_charge;
  std::vector<float>       allParticle_pt;
  std::vector<float>       allParticle_eta;
  std::vector<float>       allParticle_phi;
  std::vector<float>       allParticle_dxy;
  std::vector<float>       allParticle_dz;
  std::vector<float>       allParticle_exy;
  std::vector<float>       allParticle_ez;
