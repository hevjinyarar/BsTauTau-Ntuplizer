...
process.TFileService = cms.Service("TFileService",
                                    fileName = cms.string('flatTuple_test5M.root')
                                   )
...
process.ntuplizer = cms.EDAnalyzer("Ntuplizer",
    ...
    doAllParticles    = cms.bool(config["DOALLPARTICLES"]), # change
